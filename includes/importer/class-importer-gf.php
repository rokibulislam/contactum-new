 ...
 */
class Importer_GF extends Importer_Abstract {
    ...
    public function get_form_settings( $form ) {
        ...
        $form_settings = [
            ...
            'page_id'            => '',
            'url'                => '',
            'submit_text'        => !empty( $form['button']['text'] ) ? $form['button']['text'] : __( 'Submit Query', 'contactum' ),
    ...
    private function get_file_type( $extension ) {
        $allowed_extensions = contactum_allowed_extensions();
