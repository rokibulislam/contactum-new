...
function contactum_free_get_modules() {
    ...
    */
        ...
        'google_analytics' => [
            'name'         => __('Google Analytics', 'contactum'),
            'description'  => __('Send a GA4 event for every form submission via the Measurement Protocol.', 'contactum'),
            'thumbnail'    => CONTACTUM_ASSETS. '/images/integrations/icon-google-analytics.svg',
            'enabled'      => 'no',
            'purchase_url' => $purchaseUrl,
            'category'     => 'analytics',
        ],
        'google_calendar' => [
            'name'         => __('Google Calendar', 'contactum'),
            'description'  => __('Automatically create a Google Calendar event from every form submission — handy for bookings, appointments, and RSVPs.', 'contactum'),
            'thumbnail'    => CONTACTUM_ASSETS. '/images/integrations/icon-google-calendar.svg',
            'enabled'      => 'no',
            'purchase_url' => $purchaseUrl,
            'category'     => 'productivity',
        ],
        'google_drive' => [
            'name'         => __('Google Drive', 'contactum'),
            'description'  => __('Automatically upload form file/image submissions to your Google Drive.', 'contactum'),
            'thumbnail'    => CONTACTUM_ASSETS. '/images/integrations/icon-google-drive.svg',
            'enabled'      => 'no',
            'purchase_url' => $purchaseUrl,
            'category'     => 'storage',
        ],
        'google_sheets' => [
            'name'         => __('Google Sheets', 'contactum'),
            'description'  => __('Automatically append every form submission as a new row in a Google Sheet.', 'contactum'),
            'thumbnail'    => CONTACTUM_ASSETS. '/images/integrations/google-sheets.jpg',
            'enabled'      => 'no',
            'purchase_url' => $purchaseUrl,
            'category'     => 'productivity',
        ],
        'cloudflare_r2' => [
            'name'         => __('Cloudflare R2', 'contactum'),
            'description'  => __('Store form file and image uploads directly in a Cloudflare R2 bucket instead of (or alongside) your server.', 'contactum'),
            'thumbnail'    => CONTACTUM_ASSETS. '/images/integrations/icon-cloudflare-r2.svg',
            'enabled'      => 'no',
            'purchase_url' => $purchaseUrl,
            'category'     => 'storage',
        ],
        'dropbox' => [
            'name'         => __('Dropbox', 'contactum'),
            'description'  => __('Automatically upload form file/image submissions to your Dropbox.', 'contactum'),
            'thumbnail'    => CONTACTUM_ASSETS. '/images/integrations/icon-dropbox.svg',
            'enabled'      => 'no',
            'purchase_url' => $purchaseUrl,
            'category'     => 'storage',
        ],
        'onedrive' => [
            'name'         => __('Microsoft OneDrive', 'contactum'),
            'description'  => __('Automatically upload form file/image submissions to your Microsoft OneDrive.', 'contactum'),
            'thumbnail'    => CONTACTUM_ASSETS. '/images/integrations/icon-onedrive.svg',
            'enabled'      => 'no',
            'purchase_url' => $purchaseUrl,
            'category'     => 'storage',
        ],
        'landing_page' => [
            'name'         => __('Landing Page', 'contactum'),
            'description'  => __('Publish any form as its own distraction-free, full-page landing page — no theme header/footer, with its own background, logo, heading, and an optional private share link.', 'contactum'),
            'thumbnail'    => CONTACTUM_ASSETS. '/images/integrations/quiz.png',
            'enabled'      => 'no',
            'purchase_url' => $purchaseUrl,
            'category'     => 'productivity',
        ],
        'n8n' => [
            'name'         => __('n8n', 'contactum'),
            'description'  => __('Send every form submission to one or more n8n workflow webhooks, with an optional custom auth header per workflow.', 'contactum'),
            'thumbnail'    => CONTACTUM_ASSETS. '/images/integrations/icon-n8n.svg',
            'enabled'      => 'no',
            'purchase_url' => $purchaseUrl,
            'category'     => 'automation',
        ],
        'notion' => [
            'name'         => __('Notion', 'contactum'),
            'description'  => __('Notion is an all-in-one workspace for notes, docs, and databases. Send every form submission straight into a Notion database as a new page.', 'contactum'),
            'thumbnail'    => CONTACTUM_ASSETS. '/images/integrations/icon-notion.svg',
            'enabled'      => 'no',
            'purchase_url' => $purchaseUrl,
            'category'     => 'productivity',
        ],
        'pdf_submission' => [
            'name'         => __('PDF Form Submission', 'contactum'),
            'description'  => __('Generate a PDF summary of every submission, downloadable from the entry and optionally attached to email notifications.', 'contactum'),
            'thumbnail'    => CONTACTUM_ASSETS. '/images/integrations/icon-pdf-submission.svg',
            'enabled'      => 'no',
            'purchase_url' => $purchaseUrl,
            'category'     => 'productivity',
        ],
        'payment' => [
            'name'         => __('Payment', 'contactum'),
            'description'  => __('Receive payments', 'contactum'),
            'thumbnail'    => CONTACTUM_ASSETS. '/images/integrations/payment.svg',
            'enabled'      => 'no',
            'purchase_url' => $purchaseUrl,
            'category'     => 'payment',
        ],
        'post_submission' => [
            'name'         => __('Post Submission', 'contactum'),
            'description'  => __('Turn form submissions into new WordPress posts, with category/featured-image mapping and configurable post status.', 'contactum'),
            'thumbnail'    => CONTACTUM_ASSETS. '/images/integrations/icon-post-submission.svg',
            'enabled'      => 'no',
            'purchase_url' => $purchaseUrl,
            'category'     => 'productivity',
        ],
        'quiz_scoring' => [
            'name'         => __('Quiz Scoring', 'contactum'),
            'description'  => __('Turn Radio, Checkbox, and Select fields into graded quiz questions using their existing "Calc" point values, and save a total score on every entry.', 'contactum'),
            'thumbnail'    => CONTACTUM_ASSETS. '/images/integrations/quiz.png',
            'enabled'      => 'no',
            'purchase_url' => $purchaseUrl,
            'category'     => 'productivity',
        ...
        'twilio' => [
            'name'         => __('Twilio SMS', 'contactum'),
            'description'  => __('Send an SMS via Twilio for every form submission — order confirmations, appointment reminders, OTP-style alerts, and more.', 'contactum'),
            'thumbnail'    => CONTACTUM_ASSETS. '/images/integrations/icon-twilio.svg',
            'enabled'      => 'no',
            'purchase_url' => $purchaseUrl,
            'category'     => 'communication',
        ],
        'user_registration' => [
            'name'         => __('User Registration', 'contactum'),
            'description'  => __('Turn form submissions into new WordPress user accounts, with optional admin approval and auto-login.', 'contactum'),
            'thumbnail'    => CONTACTUM_ASSETS. '/images/integrations/icon-user-registration.svg',
            'enabled'      => 'no',
            'purchase_url' => $purchaseUrl,
            'category'     => 'productivity',
        ],
        'woocommerce' => [
            'name'         => __('WooCommerce Product Addon', 'contactum'),
            'description'  => __('Attach a Contactum form to a WooCommerce product. Field values are captured into the cart and order; Single/Multiple Product fields on the form add real priced options to the cart price.', 'contactum'),
            'thumbnail'    => CONTACTUM_ASSETS. '/images/integrations/icon-woocommerce.svg',
            'enabled'      => 'no',
            'purchase_url' => $purchaseUrl,
            'category'     => 'ecommerce',
        ],
        'zapier' => [
            'name'         => __('Zapier', 'contactum'),
            'description'  => __('Send every form submission to one or more named Zapier catch hooks.', 'contactum'),
            'thumbnail'    => CONTACTUM_ASSETS. '/images/integrations/icon-zapier.png',
            'enabled'      => 'no',
            'purchase_url' => $purchaseUrl,
            'category'     => 'automation',
        ],
