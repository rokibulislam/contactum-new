        ...
        <div class="contactum_settings_sidebar contactum_layout_section_sidebar">
          <ul class="contactum_settings_list contactum_list_button">
            <li class="contactum_list_button_item has_sub_menu">
              <a class="contactum_list_button_link" href="#" disabled> Settings </a>
              <ul class="contactum_list_submenu">
                <li class="contactum_list_button_item">
                  <a class="contactum-page-scroll" href="#"
                     data-hash="layout"
                ...
                <li class="contactum_list_button_item">
                  <a class="contactum-page-scroll" href="#"
                     data-hash="confirmation"
                     @click.prevent="scrollToSection"
                  > Confirmation Settings </a>
                </li>
                <li class="contactum_list_button_item">
                  <a class="contactum-page-scroll" href="#"
                     data-hash="scheduling"
                     @click.prevent="scrollToSection"
                  > Scheduling & Restrictions </a>
                </li>
                <li class="contactum_list_button_item">
                  <a class="contactum-page-scroll" href="#"
                     data-hash="custom-css-js"
                     @click.prevent="scrollToSection"
                  > custom css & js</a>
                </li>
              </ul>
...
export default {
  ...
  mounted() {
    const $el = jQuery(
        '.contactum_settings_list a[data-hash="' + this.$route.path + '"]'
    );
    if ($el.length) {
      handleSidebarActiveLink($el.parent());
    } else {
      const $firstLink = jQuery(
          ".contactum_settings_list li:first-child"
      ).first();
    ...
    jQuery(".contactum_settings_list a").on("click", function (e) {
      const $el = jQuery(this);
      if ($el.attr("href") === "#" || "/" === $el.data("hash")) {
        e.preventDefault();
      }
      handleSidebarActiveLink($el.parent());
    });
  ...
  methods: {
    ...
    scrollToSection(event) {
      const targetId = event.currentTarget.getAttribute("data-hash")
    ...
    scrollTo() {
      let pageScrollLink = jQuery(".contactum-page-scroll");
